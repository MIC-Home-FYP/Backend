...
# def route_tools(
#     state: State,
# ) -> Literal["tools", "search_tool","__end__"]:
#     """
...
#         return "tools"
#     return "__end__"
def route_tools(state: State) -> Literal["rag_tools", "search_tool", "__end__"]:
    ...
    if not last_message.tool_calls:
        return "__end__"
    elif last_message.tool_calls[0].function.name == "search_tool":
        return "search_tool"
    else:
        return "rag_tools"
